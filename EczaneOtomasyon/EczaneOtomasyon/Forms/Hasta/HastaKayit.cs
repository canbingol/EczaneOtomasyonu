...
{
    public partial class HastaKayit : Form, IHastaİslemleri
    {
        // yapıcı metod 
        public HastaKayit()
        {
        ...
        private void btn_hastaKaydet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // textboxtan alınan değerlerin boş olup olmaddığını kontrol eder
                ...
                // girilen tc no nun daha önce kayıtlı olmadığını kontrol eder
                ...
                {
                    con.Open();
                    OleDbCommand hastaEkle = new OleDbCommand("INSERT INTO Hastalar (adi, soyadi, tc, adres, telno,sigorta) VALUES (@ad, @soyad,@tcno, @adres,  @telno,@sigorta)", con);
                    ...
                    if (sayac > 0) // kayıt eklendi ise çalışır
                    {
                        AlanlariTemizle(txt_tcNo, txt_ad, txt_soyad, txt_telNo, txt_adres);
        ...
        // girilen tc nun daha önce kayıtlı olup olmadığını kontrol eder
